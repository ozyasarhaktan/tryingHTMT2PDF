        ...
        <v-container cols="12" min-width="600px" max-width="600px" min-height="400px" max-height="400px" >
          ...
          <div class="d-flex flex-row float-right">
            <div>
              ...
              v-on="on"
            ></v-text-field>
            <v-date-picker v-model="baslangincDate" range no-title scrollable></v-date-picker>
            </div>
            </div>
...
export default {
  ...
  computed:{
    dateFormattedStart(){
      if (this.baslangincDate) {
          let [year , month , day] = `${baslangincDate.substr(0,4)}  /  ${baslangincDate.substr(5,7)} / ${baslangincDate.substr(8,10)} `
          // const options = {
          //     year: 'numeric',
          //     month: 'long',     2323-23-23
          //     day: 'numeric'
          // };
          // return new Date(this.baslangincDate).toISOString(). ;
